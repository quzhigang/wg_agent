...
本文档精选了卫共数字孪生流域防洪预报预演系统的部分API接口，包括子流域洪水结果、洪水淹没分析、防汛预案、水雨情态势研判、闸站工情、以及MIKE模型计算相关辅助接口。接口基础地址为：<http://10.20.2.153/api/basin>
...
**用途**: 删除产流结果
**请求方式**: POST
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/modelResultOutflow/delete`
**输入参数**:
...
**用途**: 获取子流域基础信息清单
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/modelResultOutflow/getBasinList`
**输入参数**:
...
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/modelResultOutflow/detail`
**输入参数**:
...
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/modelResultOutflow/source`
**输入参数**:
...
**用途**: 分页查询淹没分析方案列表
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/loss/list`
**输入参数**:
...
**用途**: 新增淹没分析方案
**请求方式**: POST
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/loss/add`
**输入参数**:
...
**用途**: 删除淹没分析方案
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/loss/delete`
**输入参数**:
...
**用途**: 执行淹没分析方案计算
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/loss/calc`
**输入参数**:
...
**用途**: 获取淹没分析方案及结果数据
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/loss/detail`
**输入参数**:
...
**用途**: 获取淹没分布GIS数据
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/loss/gis`
**输入参数**:
...
**用途**: 自动计算淹没分析(无需登录)
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/loss/auto`
**输入参数**: 无
**输出结果**:
...
**用途**: 查询全部防汛预案列表(不分页)
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/flood/floodPlan/listAll`
**输入参数**:
...
**用途**: 新增防汛预案(支持文件上传)
**请求方式**: POST
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/flood/floodPlan/add`
**输入参数**:
...
**用途**: 删除防汛预案
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/flood/floodPlan/delete`
**输入参数**:
...
**用途**: 查看防汛预案详情
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/flood/floodPlan/detail`
**输入参数**:
...
**用途**: 获取防汛预案类型目录
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/flood/floodPlan/catalog`
**输入参数**: 无
**输出结果**:
...
**用途**: 获取水库河道实时水情(无需登录)
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/monitor/rsvr/now`
**输入参数**: 无
**输出结果**:
...
**用途**: 获取水库当前形势统计
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/monitor/rsvr/stc`
**输入参数**: 无
**输出结果**:
...
**用途**: 水雨情态势过程回溯
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/monitor/rsvr/track`
**输入参数**:
...
**用途**: 水库纳蓄能力分析
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/monitor/rsvr/storage`
**输入参数**:
...
**用途**: 获取闸门工情(无需登录)
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/mike/init/gate`
**输入参数**: 无
**输出结果**:
...
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/mike/runoff`
**输入参数**:
...
**用途**: 获取水库基本信息(无需登录)
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/mike/rsvrInfo`
**输入参数**:
...
**用途**: 获取水库的可控建筑物
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/mike/control`
**输入参数**:
...
**用途**: 获取蓄滞洪区的库容曲线
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/mike/hvrela`
**输入参数**:
...
**用途**: 获取指定时刻的水情
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/mike/specTime`
**输入参数**:
...
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/mike/calPa`
**输入参数**:
...
**请求方式**: GET
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/mike/fsda/struct`
**输入参数**:
...
**请求方式**: POST
**请求路径**: `http://10.20.2.153/api/basin/modelPlatf/model/mike/fsda/setBoundary`
**输入参数**:
